...
const generateVideo = async () => {
  ...
  try {
    ...
    const taskParams: any = {
      ...
      video_aspect: settingsStore.video.aspect === 'landscape' ? '16:9' : settingsStore.video.aspect === 'portrait' ? '9:16' : settingsStore.video.aspect === 'portrait_3_4' ? '3:4' : settingsStore.video.aspect === 'landscape_4_3' ? '4:3' : settingsStore.video.aspect === 'square' ? '1:1' : '9:16',
