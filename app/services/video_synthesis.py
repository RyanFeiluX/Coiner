...
def recover_video_synthesis(task_id_or_path: str, progress_callback=None, start_scene=None, end_scene=None, task_id: str = None, subtitle_params: dict = None, bgm_params: dict = None, title_params: dict = None, check_cancelled=None, task_create_time: float = None) -> str:
    ...
    try:
        ...
        params = VideoParams(
            ...
            # Subtitle params (scene-level): subtitle_params > original_params > app_config > subtitle_config > ui_config
            subtitle_enabled=subtitle_params.get('subtitle_enabled') if subtitle_params.get('subtitle_enabled') is not None else (original_params.get('subtitle_enabled') if original_params.get('subtitle_enabled') is not None else app_config.get("subtitle_enabled", subtitle_config.get("subtitle_enabled", ui_config.get("subtitle_enabled", True)))),
            font_name=subtitle_params.get('font_name') or original_params.get('font_name') or app_config.get("font_name", subtitle_config.get("font_name", ui_config.get("font_name", "STHeitiMedium.ttc"))),
            font_size=subtitle_params.get('font_size') or original_params.get('font_size') or app_config.get("font_size", subtitle_config.get("font_size", ui_config.get("font_size", 60))),
            text_fore_color=subtitle_params.get('text_fore_color') or original_params.get('text_fore_color') or app_config.get("text_fore_color", subtitle_config.get("text_fore_color", ui_config.get("text_fore_color", "white"))),
            text_background_color=subtitle_params.get('text_background_color') if subtitle_params.get('text_background_color') is not None else (original_params.get('text_background_color') if original_params.get('text_background_color') is not None else app_config.get("text_background_color", subtitle_config.get("text_background_color", ui_config.get("text_background_color", "transparent")))),
            stroke_color=subtitle_params.get('stroke_color') or original_params.get('stroke_color') or app_config.get("stroke_color", subtitle_config.get("stroke_color", ui_config.get("stroke_color", "black"))),
            stroke_width=subtitle_params.get('stroke_width') or original_params.get('stroke_width') or app_config.get("stroke_width", subtitle_config.get("stroke_width", ui_config.get("stroke_width", 2))),
            subtitle_position=subtitle_params.get('subtitle_position') or original_params.get('subtitle_position') or app_config.get("subtitle_position", subtitle_config.get("subtitle_position", ui_config.get("subtitle_position", "bottom"))),
            custom_position=subtitle_params.get('custom_position') or original_params.get('custom_position') or app_config.get("subtitle_custom_position", subtitle_config.get("subtitle_custom_position", ui_config.get("subtitle_custom_position", 70.0))),
